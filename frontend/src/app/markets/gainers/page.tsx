...
import { TrendUp, ArrowLeft, CircleNotch } from "@phosphor-icons/react";
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-bold flex items-center gap-2">
              <TrendUp className="h-6 w-6 text-market-up" />
              Top Gainers
            </h1>
                ...
                {companies.map((company, index) => (
                  <tr key={company.symbol} className="hover:bg-terminal-bg-elevated">
                    ...
                    <td className="px-4 py-3 text-right">
                      <span className="px-2 py-1 bg-market-up/20 text-market-up rounded text-sm font-mono">
