...
const reports: ResearchReport[] = [
  {
    id: "1",
    title: "South African Banks: Navigating the Rate Cycle",
    summary: "An in-depth analysis of the major South African banks and their positioning as the interest rate cycle turns. We examine loan growth, credit quality, and dividend sustainability.",
  ...
  {
    id: "2",
    title: "Naspers/Prosus: Unlocking Value",
    summary: "We analyze the discount to NAV, Tencent exposure, and management's ongoing efforts to close the valuation gap through buybacks and asset sales.",
  ...
  {
    id: "3",
    title: "Nigeria 2025 Outlook: Reform Momentum",
    summary: "A comprehensive review of Nigeria's economic reforms, their impact on the Naira, and opportunities for investors in the year ahead.",
  ...
  {
    id: "4",
    title: "African Mining: The Battery Metals Opportunity",
    summary: "An exploration of Africa's critical mineral resources and the companies positioned to benefit from the electric vehicle revolution.",
  ...
  {
    id: "5",
    title: "MTN Group: Pan-African Growth",
    summary: "We examine MTN's operations across Africa, fintech ambitions, and the path to value creation as mobile money adoption accelerates.",
    author: "Amara Obi",
    date: "2025-01-10",
    category: "Equity Research",
    type: "equity",
  ...
  {
    id: "6",
    title: "African Fixed Income Strategy Q1 2025",
    summary: "Our recommended positioning across African sovereign and corporate bonds, considering inflation trajectories and currency dynamics.",
