      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            {/* Newsletter Info */}
            <div className="relative overflow-hidden bg-terminal-bg-secondary rounded-lg border border-terminal-border p-4">
              <div className="absolute inset-0 pointer-events-none"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" className="opacity-[0.07] dark:opacity-[0.10]"><defs><pattern id="profile-sub-grid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="hsl(355, 70%, 38%)" strokeWidth="1"/></pattern></defs><rect width="100%" height="100%" fill="url(#profile-sub-grid)"/></svg></div>
              <h3 className="relative font-semibold mb-4">Your Newsletters</h3>
              <div className="relative p-4 bg-brand-orange/10 border border-brand-orange/30 rounded-lg">
