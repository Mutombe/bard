          ...
          <div>
            <div className="sticky top-24 space-y-6">
              <div className="relative overflow-hidden bg-terminal-bg-secondary border border-terminal-border p-6">
                <div className="absolute inset-0 pointer-events-none"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" className="opacity-[0.07] dark:opacity-[0.10]"><defs><pattern id="faq-sub-grid" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke="hsl(355, 70%, 38%)" strokeWidth="1"/></pattern></defs><rect width="100%" height="100%" fill="url(#faq-sub-grid)"/></svg></div>
                <h3 className="relative text-lg font-semibold mb-2">Subscribe to Finance Africa Quarterly</h3>
